...
def getVoltage():
    ...
    ##########################################
    return volt# Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    #################################################
    draw.text((40, 0), "Gregory 24", font=font, fill=255)
    ...
    x = str(getVoltage())
    draw.text((0, 40), "Robot Voltage: " + x + 'V', font=font, fill=255)
    #################################################
    ...
    #       You will draw.text the "Robot Voltage: " starting at psixel coordinates (0,40).
